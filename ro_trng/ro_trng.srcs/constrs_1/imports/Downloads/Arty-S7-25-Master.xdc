...
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets -hierarchical -filter {DONT_TOUCH == 1 && NAME =~ *ro_bank_0*}]
set_false_path -through [get_nets -hierarchical -filter {DONT_TOUCH == 1 && NAME =~ *ro_bank_0*}]
